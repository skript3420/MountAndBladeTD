...
#GTD - Added custom Harlaus attributes for modded version
#modded
...
#This troop is the troop marked as soldiers_begin
  #GTD removed pitch_fork, added fur_coat
  ...
  #GTD removed bolts, hunting_crossbow, light_crossbow
  ...
  #GTD removed tf_mounted, tf_guarantee_horse
  ...
  #GTD removed tf_mounted, tf_guarantee_shield, tab_shield_heater_c
...
#peasant - retainer - footman - man-at-arms -  knight
  #GTD removed tab_shield_heater_a
  ...
  #GTD removed bolts, hunting_crossbow
...
# Vaegir watchman?
  #GTD removed tab_shield_kite_a (2 instances)
  ...
  #GTD removed tf_guarantee_shield
  ...
  #GTD removed arrows, short_bow, hunting_bow
  ...
  #GTD changed wp_archery from 140 to 220, changed knows_athletics from 3 to 5
  ...
  #GTD removed arrows, hunting_bow, replaced leather_vest and steppe_armor with linen_tunic, shirt, courtly_outfit
  ...
  #GTD removed tf_mounted, tf_guarantee_horse, arrows, nomad_bow
  ...
  #GTD added tab_shield_small_round_c to equipment list
  ...
  #GTD removed tab_shield_round_a (2 instances)
  ...
  #GTD removed tf_guarantee_shield, tf_guarantee_helmet
  ...
  #GTD removed tf_guarantee_shield, tab_shield_round_e
  ...
  #GTD changed wp_archery from 120 to 150
  ...
  #GTD removed pitch_fork, tab_shield_pavise_a
  ...
  ["rhodok_sharpshooter","Rhodok Sharpshooter","Rhodok Sharpshooters",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_ranged|tf_guarantee_shield,0,0,fac_kingdom_5,
   ...
   #GTD changed wp_crossbow from 140 to 160
...
#peasant - retainer - footman - man-at-arms -  knight
 ...
 #GTD changed wp_archery from 130 to 180
 ...
 ["sarranid_mamluke","Sarranid Mamluke","Sarranid Mamlukes",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_6,
  ...
  #GTD removed rawhide_coat, nomad_armor (2 instances)
  ...
  #GTD removed arrows, short_bow, nordic_shield, saddle_horse
  ...
  #GTD removed tf_mounted, tf_guarantee_horse, arrows, long_bow, hide_covered_round_shield, saddle_horse
  ...
  #GTD removed tf_guarantee_ranged, arrows, short_bow, hunting_bow
  ...
  #GTD removed tf_mounted, tf_guarantee_horse, arrows, nomad_bow, short_bow, saddle_horse, arabian_horse_a
...
#GTD removed itm_charger (horse), itm_tab_shield_heater_cav_b (shield), changed wp 
#governers olgrel rasevas                                                                       Bodywear                Footwear_in                     Footwear_out                    Armor                       Weapon                             Headwaer
  ["kingdom_1_lord",  "King Harlaus",  "Harlaus",  tf_hero, 0,reserved,  fac_kingdom_1,[   itm_rich_outfit,        itm_blue_hose,                  itm_plate_boots,               itm_mail_hauberk, itm_gauntlets,    itm_bastard_sword_b,       itm_great_helmet],          knight_attrib_5|str_10, wp(220),knight_skills_5|knows_trainer_5, 0x0000000f45041105241acd2b5a66a86900000000001e98310000000000000000,swadian_face_older_2],
...
# Add Extra Quest NPCs below this point  
  ...
  ["fugitive","Nervous Man","Nervous Men",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners,
   ...
   #GTD removed tf_guarantee_armor
...
#modded now mounted suicide bomber 5dmg
  #GTD added tf_mounted, tf_guarantee_horse, added itm_courser
  ...
  #GTD removed tabard, leather_vest, replaced sword_viking_1 with cudgel and wooden_stick
...
#Multiplayer ai troops #modded without bow, arrow, bolt , crossbow
  ...
  #GTD removed khergit_bow, khergit_arrows
  ...
  #GTD removed heavy_crossbow, bolts
...
#   def_attrib_multiplayer|level(20),wp_melee(100)|wp_crossbow(120),knows_common_multiplayer|knows_riding_4|knows_shield_3|knows_ironflesh_3|knows_horse_archery_2|knows_power_strike_3|knows_athletics_2|knows_shield_2,swadian_face_young_1, swadian_face_old_2],
  ...
  ["khergit_veteran_horse_archer_multiplayer","Khergit Horse Archer","Khergit Horse Archers",tf_mounted|tf_guarantee_all,0,0,fac_kingdom_3,
   ...
   #GTD changed wp_archery from 142 to 160
  ...
  ["sarranid_archer_multiplayer","Sarranid Archer","Sarranid Archers",tf_guarantee_all,0,0,fac_kingdom_6,
   ...
   #GTD changed wp_archery from 150 to 140
  ...
  #GTD removed rawhide_coat (2 instances), added knows_athletics_1
  ...
  ["vaegir_spearman_multiplayer_coop_tier_1","Vaegir Spearman","Vaegir spearman",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_ranged|tf_guarantee_shield,0,0,fac_kingdom_2,
   [itm_tab_shield_kite_a, itm_axe,itm_rawhide_coat,itm_hide_boots],
    level(4)|str_20, wp(300), knows_power_draw_10|knows_power_throw_10|knows_riding_10, 0, 0],
  #GTD removed tab_shield_kite_cav_a
  ...
  ["sarranid_footman_multiplayer_coop_tier_1","Sarranid Footman","Sarranid footman",tf_guarantee_all,0,0,fac_kingdom_6,
   [itm_tab_shield_kite_a, itm_sarranid_axe_a,itm_sarranid_cloth_robe, itm_sarranid_boots_b],
    level(4)|str_20, wp(300), knows_power_draw_10|knows_power_throw_10|knows_riding_10, 0, 0],
  #GTD removed tab_shield_small_round_a
  ...
  ["sarranid_mamluke_multiplayer_coop_tier_2","Sarranid Mamluke","Sarranid Mamluke",tf_mounted|tf_guarantee_all,0,0,fac_kingdom_6,
   [itm_tab_shield_small_round_b,itm_heavy_lance,itm_javelin,itm_archers_vest, itm_sarranid_warrior_cap,itm_leather_gloves,itm_sarranid_boots_b,itm_arabian_horse_a],
    level(5)|str_20, wp(300), knows_power_draw_10|knows_power_throw_10|knows_riding_10, 0, 0],
  ...
  ["khergit_infantry_multiplayer_coop_tier_4","Khergit Infantry","Khergit Infantries",tf_guarantee_all,0,0,fac_kingdom_3,
   [itm_hafted_blade_b,itm_tab_shield_small_round_a,itm_jarid,itm_khergit_elite_armor,itm_khergit_guard_boots,itm_khergit_war_helmet,itm_lamellar_gauntlets],
    level(7)|str_20, wp(300), knows_power_draw_10|knows_power_throw_10|knows_riding_10, 0, 0],
  #GTD removed tf_mounted, tab_shield_small_round_c, courser
  ...
  ["rhodok_veteran_crossbowman_multiplayer_coop_tier_4","Rhodok Crossbowman","Rhodok Crossbowmen",tf_guarantee_all,0,0,fac_kingdom_5,
   [itm_sniper_crossbow,itm_steel_bolts,itm_sledgehammer,itm_tab_shield_pavise_d,itm_mail_with_tunic_green,itm_kettle_hat,itm_splinted_greaves,itm_leather_gloves],
    level(7)|str_20, wp(300), knows_power_draw_10|knows_power_throw_10|knows_riding_10, 0, 0],
  #GTD removed tab_shield_pavise_d
